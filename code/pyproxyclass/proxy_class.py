...
class ClassMethodHandler:
    ...
    def __get__(self, instance, owner):
        ...
        return partial(
            self.invocation_handler.__call__, instance=instance, method=self.method
        )
...
class WrapperClass(ProxyClass):
    ...
    def create_wrapper_class(
        base_object: T, invocation_handler: t.Optional[PassthroughInvocationHandler]
    ) -> T:
        if invocation_handler is None:
