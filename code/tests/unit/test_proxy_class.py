from pyproxyclass import ProxyClass, PassthroughInvocationHandler
...
class TestProxyClass:
    ...
    def test_proxy_class_init(self):
        ...
        proxy_class = ProxyClass.create_proxy_class(
            self.Prueba, PassthroughInvocationHandler(prueba)
        )
        print(proxy_class)
